...
library Bytes {
    ...
    function readBytes(
        ...
        uint256 offset,
        uint256 length
    ) internal pure returns (bytes memory result, uint256 nextOffset) {
     ...
     */
    function readUint256(bytes memory input, uint256 offset)
        internal
        pure
        returns (uint256 result, uint256 nextOffset)
    {
     ...
     */
    function readUint160(bytes memory input, uint256 offset)
        internal
        pure
        returns (uint160 result, uint256 nextOffset)
    {
     ...
     */
    function readUint128(bytes memory input, uint256 offset)
        internal
        pure
        returns (uint128 result, uint256 nextOffset)
    {
     ...
     */
    function readUint64(bytes memory input, uint256 offset)
        internal
        pure
        returns (uint64 result, uint256 nextOffset)
    {
     ...
     */
    function readUint32(bytes memory input, uint256 offset)
        internal
        pure
        returns (uint32 result, uint256 nextOffset)
    {
     ...
     */
    function readUint16(bytes memory input, uint256 offset)
        internal
        pure
        returns (uint16 result, uint256 nextOffset)
    {
